...
int main()
{
    ...
    // Присвоение значения 15 первому элементу массива arr структуры s1
    s1.arr[0] = 15;
    ...
    // Изменение значения первого элемента массива arr структуры s напрямую
    s.arr[0] = 25;
    ...
    // Присвоение указателю sPointer адреса структуры s
    sPointer = &s;
